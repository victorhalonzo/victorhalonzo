...
public class MyLocation extends AppCompatActivity {
    ...
    class GetLastLocation extends TimerTask {
        ...
        public void run() {
            ...
            //System.out.println(mcontext.getPackageManager().getPermissionInfo();
            ActivityCompat.requestPermissions(MyLocation.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
            if (ActivityCompat.checkSelfPermission((Activity)mcontext, Manifest.permission.ACCESS_FINE_LOCATION) != mcontext.getPackageManager().PERMISSION_GRANTED)
            {
                System.out.println("no hay permiso");
                Toast.makeText(MyLocation.this, "No hay permiso para mostrar la ubicación." , Toast.LENGTH_LONG).show();
